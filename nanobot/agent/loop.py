...
class AgentLoop:
    ...
    def __init__(
        ...
        self.context = ContextBuilder(workspace, timezone=timezone, cloud_config=cloud_config)
        self.sessions = session_manager or SessionManager(workspace, cloud_config=cloud_config)
